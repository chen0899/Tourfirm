...
<div class="container mt-5">
    <form action="/update-booking" method="post">
        ...
        <div class="form-group row">
            ...
            <input type="date" class="form-control col-sm-4" name="startDate" value="${booking.getStartDate()}"/>
        </div>
        <div class="form-group row">
            <label class="col-sm-2 col-form-label">End date</label>
            <input type="date" class="form-control col-sm-4" name="endDate" value="${booking.getEndDate()}"/>
        </div>
        <div class="form-group row">
            <label class="col-sm-2 col-form-label">Client id</label>
            <input type="text" class="form-control col-sm-4" name="clientId" value="${booking.getClient().getId()}"/>
        </div>
        <div class="form-group row">
            <label class="col-sm-2 col-form-label">Room id</label>
            <input type="text" class="form-control col-sm-4" name="roomId" value="${booking.getRoom().getId()}"/>
        </div>
